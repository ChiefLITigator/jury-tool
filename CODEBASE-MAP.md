...
| app-shared.js | 328 | ~3,000 | Active | Yes — shared utilities, CACI lookup, print, modal |
...
| app-draft.js | 591 | ~6,300 | Active | Yes — instruction drafter |
| app-packet.js | 200 | ~1,900 | Active | Yes — packet tray |
| app-cases.js | 245 | ~2,400 | Active | Yes — localStorage case system |
| app-browse.js | 229 | ~1,400 | Active | When touching browse/search panel |
...
- CACI 115 (class certification) excluded via `CACI_UNAVAILABLE` blocklist in app-shared.js — returns "instruction not available"

...
## CLAUDE.AI SESSION ANCHOR TEMPLATE

Paste this block at the top of every new Claude.ai design session:

```
[CLAUDE.AI SESSION ANCHOR]
Date: ___
CODEBASE-REVIEW.md last updated: ___
Working on: ___
Files involved: ___
...
Produce this block at the end of any Claude.ai design session before moving to Claude Code:
